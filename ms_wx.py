...
async def wrd_wx(ctx):
    async with ctx.typing():
        ...
        for city, temp in temperatures.items():
            ...
            # Plot temperature with a background box for better readability
            ax.text(
                lon,
                lat + 0.1,
                f"{temp:.0f}°F",
            ...
            if icon_path and os.path.exists(icon_path):
                ...
                ab = AnnotationBbox(
                    ...
                    xybox=(30, 0),  # Offset to move the icon to the right
                    xycoords='data',
        ...
        plt.title(f"Georgia Temperatures and Dew Points ({current_time})", fontsize=16, fontweight='bold')
